    ...
    <section class="py-5 bg-gray-100 shadow">
      <div class="container">
        ...
        <ul class="nav nav-pills-custom">
          <li class="nav-item"><a class="nav-link active" href="#">Mount Vernon</a></li>
          <li class="nav-item"><a class="nav-link" href="#">Johnstown</a></li>
          <li class="nav-item"><a class="nav-link" href="#">Jamestown</a></li>
          <li class="nav-item"><a class="nav-link" href="#">Hudson</a></li>
          <li class="nav-item"><a class="nav-link" href="#">Kingston</a></li>
        </ul>
      </div>
    </section>
    <section class="py-5">
      <div class="container">
        ...
        <div class="row">
          ...
          <!-- venue item-->
          <div class="col-sm-6 col-lg-4 mb-5 hover-animate" data-marker-id="59c0c8e3a31e62979bf147c9">
            <div class="card h-100 border-0 shadow">
          ...
          <!-- venue item-->
          <div class="col-sm-6 col-lg-4 mb-5 hover-animate" data-marker-id="59c0c8e3503eb77d487e8082">
            <div class="card h-100 border-0 shadow">
          ...
          <!-- venue item-->
          <div class="col-sm-6 col-lg-4 mb-5 hover-animate" data-marker-id="59c0c8e39aa2eed0626e485d">
            <div class="card h-100 border-0 shadow">
